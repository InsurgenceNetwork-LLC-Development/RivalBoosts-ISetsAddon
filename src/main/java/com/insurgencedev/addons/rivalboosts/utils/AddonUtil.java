package com.insurgencedev.addons.rivalboosts.utils;
...
public class AddonUtil {
    ...
    public void getMulti(Player player, String type, String namespace, BiConsumer<Boolean, Double> ifFound) {
        ...
        for (ItemStack item : player.getInventory().getArmorContents()) {
            ...
            for (Boost boost : upgrade.getBoosts()) {
                if (boost.getNamespace().equals(namespace) && boost.getType().equals(type)) {
